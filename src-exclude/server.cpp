...
bool handleFileRead(String path){
        DBG_OUTPUT_PORT << "handleFileRead: " <<  path << endl;
...
void setupSSDP() {
        ...
        SSDP.setHTTPPort(80);
        SSDP.setName("IIoT");
        SSDP.setSerialNumber("001788102202");
        SSDP.setURL("index.html");
        SSDP.setModelName("Ikutsin IoT");
        SSDP.setModelNumber("000000000003");
        SSDP.setModelURL("http://usanov.net/");
        SSDP.setManufacturer("Ikutsin");
        SSDP.setManufacturerURL("http://usanov.net/");

        SSDP.begin();
        DBG_OUTPUT_PORT << "SSDP started" << endl;
}
...
void loop() {
        ...
        if(cnt++>100000) {
                ...
                char buffer[300];
                int size = root.printTo(buffer, 300);
